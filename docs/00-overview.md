...
| 7 | **Sin JavaScript de cliente** en v1 | Todos los efectos del diseño son CSS; el menú móvil usa la Popover API nativa | Framework islands |
| 8 | **Videos por `<iframe loading="lazy">` de YouTube** | Cero código; suficiente para 2 videos | Facade/lite-youtube (añadir si LCP se resiente) |
